...
class ScreenShotTabUpperContent extends StatefulWidget {
  const ScreenShotTabUpperContent({super.key});

  @override
  State<ScreenShotTabUpperContent> createState() =>
      _ScreenShotTabUpperContentState();
}

class _ScreenShotTabUpperContentState extends State<ScreenShotTabUpperContent> {
