...
class LocationTabUpperContent extends StatefulWidget {
  const LocationTabUpperContent({super.key});

  @override
  State<LocationTabUpperContent> createState() =>
      _LocationTabUpperContentState();
}

class _LocationTabUpperContentState extends State<LocationTabUpperContent> {
